...
mov ax, 0x07C0 
 ...
 mov ah, 0x03;mov ax, 0x0305
 ;mov bx, 0x031F
 int 0x16  ; increase delay before keybord repeat

game_loop:
 call clear_screen ; clear the screen
 push word [snake_pos] ; save snake head position for later
 in al, 0x64; check if key available
 and al, 1;
 jnz done_clear ; if not, move on
 in al, 0x60
 jmp update_snakepos
...
snake_body_print_loop:
 ...
 mov al, '-'  ; use 'o' as the snake body symbol
 call print_char ; print it
...
clear_screen:
 ...
 mov bh, 0x0F ; light white on black
